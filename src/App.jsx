...
const API_KEY = "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";
...
function App() {
  ...
  return (
    <div className="chatbotapp">
      <div style={{ backgroundColor: isBackgroundGreen ? 'lightgreen' : 'blue',}}>
      <div style={{ display: "flex", flexDirection: "column" }}>
      <h2 style={{ padding: "10px 20px", textAlign: "center", color: "red" }}>
        Life on Land Expert
      </h2>
      <div style={{ position:"relative", textAlign: "left", height: "650px", width: "600px", }}>
        <MainContainer>
          <ChatContainer>       
            <MessageList 
              scrollBehavior="smooth" 
              typingIndicator={isTyping ? <TypingIndicator content="Expert is typing" /> : null}
            >
